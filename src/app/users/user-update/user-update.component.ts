...
export class UserUpdateComponent implements OnInit {
  ...
  updateUser() {
    if (this.userForm.valid) {
      this.alertifyService.confirm(
          ...
          this.userService.updateUser(this.updatedUser).subscribe(
            (response) => {
              ...
              this.alertifyService.success(
                "Seçili kullanıcıya ait güncelleme işlemi başarı ile gerçekleşti"
              );
            ...
            (error) => {
              ...
              this.alertifyService.error(
                "Kullanıcı güncelleme başarısız: " + error
              );
            }
          );
        },
        () => {
          ...
          this.alertifyService.warning(
            "Kullanıcı güncelleme işlemini iptal ettiniz"
          );
      ...
      this.alertifyService.error(
        "Form geçerli değil, kullanıcı güncellenemedi"
      );
    }
  }
}
