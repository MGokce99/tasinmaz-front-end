...
export class TasinmazService {
  ...
  private coordinatesSubjectD: BehaviorSubject<[number, number][]> =
    new BehaviorSubject<[number, number][]>([]);
  private coordinatesSubject: BehaviorSubject<[number, number]> =
    new BehaviorSubject<[number, number]>([null, null]);
  ...
  getTasinmazByUserId(userId: number): Observable<IDataResult<Tasinmaz[]>> {
    return this.httpClient.get<IDataResult<Tasinmaz[]>>(
      this.path + "tasinmazlar/getbyuserid?userId=" + userId
    );
  }
  ...
  getIlcelerByIlId(ilId: number): Observable<Ilce[]> {
    return this.httpClient.get<Ilce[]>(
      this.path + `ilceler/getlistbycategory?categoryId=${ilId}`
    );
  }

  getMahallelerByIlceId(ilceId: number): Observable<Mahalle[]> {
    return this.httpClient.get<Mahalle[]>(
      this.path + `mahalleler/getlistbycategory?categoryId=${ilceId}`
    );
  }

  getTasinmazById(id: number): Observable<Tasinmaz> {
    return this.httpClient.get<Tasinmaz>(
      `${this.path}tasinmazlar/getbyid?parselId=` + id
    );
  }
  ...
  addTasinmaz(tasinmaz: Tasinmaz): Observable<Tasinmaz> {
    ...
    return this.httpClient
      .post<Tasinmaz>(this.path + "tasinmazlar/add", tasinmaz, httpOptions)
      .pipe(
  ...
  updateTasinmaz(tasinmaz: Tasinmaz): Observable<Tasinmaz> {
    ...
    return this.httpClient
      .put<Tasinmaz>(this.path + "tasinmazlar/update", tasinmaz, httpOptions)
      .pipe(
